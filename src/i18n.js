...
const resources = {
  ru: {
    translation: {
      ...
      art3Title: "Многофункциональные земснаряды-амфибии: технологии будущего",
      art3Desc: "Преимущества и возможности амфибийной дноуглубительной техники на мелководье.",
      art3P1: "Амфибийные земснаряды представляют собой уникальный класс оборудования, способный одинаково эффективно работать как на воде, так и на суше. Благодаря гусеничному или шагающему ходу они самостоятельно выходят на берег, преодолевают болотистые участки и работают на предельном мелководье.",
      art3P2: "В отличие от классических земснарядов, требующих сложной логистики и сборки на месте, амфибия готова к работе практически сразу после доставки на объект.",
      art3P3: "Спектр применения амфибий включает очистку водоемов от растительности, углубление дна рек и озер, укрепление берегов и ликвидацию последствий паводков.",
      art3P4: "Применение сменного навесного оборудования (ковш, грабли, фрезерный рыхлитель) делает амфибию по-настоящему универсальной инженерной машиной.",
      art3P5: "Завод DREDMARK предлагает передовые амфибийные решения, адаптированные под экстремальные климатические условия СНГ.",
      art4Title: "Опыт восстановления ирригационных каналов: проект Карши",
      art4Desc: "Практический кейс дноуглубления и очистки каналов Каршинского каскада в Узбекистане.",
      art4P1: "Ирригационные каналы Каршинского каскада в Узбекистане играют стратегическую роль в сельском хозяйстве региона. Со временем каналы подвергаются сильному заилению и потере пропускной способности, что ставит под угрозу водоснабжение полей.",
      art4P2: "Для решения этой задачи была привлечена тяжелая дноуглубительная техника DREDMARK. В рамках проекта был задействован мощный земснаряд с фрезерным рыхлителем.",
      art4P3: "Ключевой сложностью проекта являлось сильное течение и обилие твердых донных отложений, требовавших повышенной износостойкости насосного оборудования и режущих кромок.",
      art4P4: "В результате проведенных работ пропускная способность каскада была полностью восстановлена, обеспечив бесперебойную подачу воды на сельскохозяйственные поля.",
      art5Title: "Техническое обслуживание и подготовка земснаряда к сезону",
      art5Desc: "Практическое руководство по техническому обслуживанию, консервации и подготовке земснарядов к рабочему сезону.",
      art5P1: "Регулярное техническое обслуживание земснаряда — залог его долговечной и бесперебойной работы. Подготовка к сезону начинается задолго до спуска на воду и включает в себя полную диагностику всех узлов.",
      art5P2: "Особое внимание следует уделить грунтовому насосу: проверьте состояние бронедисков и рабочего колеса на предмет износа. Своевременная замена изношенных деталей предотвратит серьезные поломки в разгар сезона.",
      art5P3: "Проверьте гидравлическую систему: измерьте давление, убедитесь в отсутствии утечек и при необходимости замените масло и фильтры. Чистое масло продлевает срок службы гидромоторов фрезы и лебедок.",
      art5P4: "Завод DREDMARK оказывает полную сервисную поддержку, включая выездную диагностику и поставку оригинальных запасных частей в кратчайшие сроки.",
      art6Title: "Техника безопасности при проведении дноуглубительных работ",
      art6Desc: "Инструкции и ключевые правила техники безопасности для экипажа и обслуживающего персонала земснаряда.",
      art6P1: "Дноуглубительные работы относятся к категории работ с повышенной опасностью. Соблюдение правил техники безопасности (ТБ) обязательно для каждого члена экипажа земснаряда.",
      art6P2: "Перед началом смены необходимо провести визуальный осмотр палубы, ограждений, лебедок и проверить исправность аварийной сигнализации и кнопок экстренной остановки.",
      art6P3: "Все члены экипажа и находящиеся на борту специалисты обязаны носить спасательные жилеты и защитные каски. Работа без средств индивидуальной защиты (СИЗ) категорически запрещена.",
      art6P4: "Особое внимание уделяется состоянию силовых кабелей (для электрических земснарядов) и надежности крепления пульпопровода. Регулярный инструктаж персонала сводит риски происшествий к минимуму.",
  ...
  en: {
    translation: {
      ...
      art3Title: "Multifunctional Amphibious Dredgers: Technologies of the Future",
      art3Desc: "Advantages and capabilities of amphibious dredging equipment in shallow waters.",
      art3P1: "Amphibious dredgers represent a unique class of equipment capable of operating equally effectively on both water and land. Thanks to their crawler or walking tracks, they independently crawl ashore, cross marshy areas, and operate in extremely shallow waters.",
      art3P2: "Unlike classic dredgers, which require complex logistics and on-site assembly, an amphibian is ready for operation almost immediately after delivery to the site.",
      art3P3: "The range of applications for amphibians includes reservoir cleaning from vegetation, dredging river and lake beds, shore reinforcement, and flood mitigation.",
      art3P4: "The use of interchangeable attachments (bucket, rake, cutter head) makes the amphibian a truly versatile engineering machine.",
      art3P5: "The DREDMARK plant offers advanced amphibious solutions adapted to the extreme climate conditions of the CIS.",
      art4Title: "Restoring Irrigation Canals: The Karshi Project",
      art4Desc: "A practical case study of dredging and canal cleaning for the Karshi cascade in Uzbekistan.",
      art4P1: "Irrigation canals of the Karshi cascade in Uzbekistan play a strategic role in the region's agriculture. Over time, the canals undergo severe silting and loss of throughput capacity, threatening the water supply to the fields.",
      art4P2: "To solve this challenge, heavy dredging equipment from DREDMARK was deployed. A powerful dredger with a cutter head was utilized in the project.",
      art4P3: "The key difficulty of the project was the strong current and abundance of hard bottom sediments, which required high wear resistance of the pumping equipment and cutting edges.",
      art4P4: "As a result of the works, the throughput capacity of the cascade was fully restored, ensuring uninterrupted water supply to agricultural fields.",
      art5Title: "Technical Maintenance and Pre-Season Preparation of Dredgers",
      art5Desc: "A practical guide to technical maintenance, conservation, and preparation of dredgers for the working season.",
      art5P1: "Regular maintenance of a dredger is key to its long-term and trouble-free operation. Season preparation starts long before launch and includes a full diagnostic of all units.",
      art5P2: "Special attention should be paid to the slurry pump: inspect the wear plate and impeller for damage. Timely replacement of worn parts prevents major breakdowns in the height of the season.",
      art5P3: "Check the hydraulic system: measure pressure, ensure there are no leaks, and replace oil and filters if necessary. Clean oil extends the lifespan of cutter hydraulic motors and winches.",
      art5P4: "The DREDMARK plant provides full service support, including on-site diagnostics and prompt supply of original spare parts.",
      art6Title: "Safety Regulations during Dredging Operations",
      art6Desc: "Safety guidelines and essential rules for the crew and maintenance personnel of a dredger.",
      art6P1: "Dredging operations are categorized as high-hazard activities. Strict adherence to safety regulations is mandatory for every crew member on board.",
      art6P2: "Before starting a shift, a visual inspection of the deck, railings, and winches must be performed, along with testing emergency alarms and emergency stop buttons.",
      art6P3: "All crew members and visiting specialists are required to wear life jackets and safety helmets. Working without personal protective equipment (PPE) is strictly prohibited.",
      art6P4: "Special focus is given to the electrical cables (for electric dredgers) and pipeline joints' reliability. Regular safety briefings for staff minimize project risks.",
  ...
  uz: {
    translation: {
      ...
      art3Title: "Ko'p funksiyali amfibiya zemsnaryadlari: kelajak texnologiyalari",
      art3Desc: "Sayoz suvlarda amfibiya tipidagi daryo tozalash uskunalarining afzalliklari va imkoniyatlari.",
      art3P1: "Amfibiya zemsnaryadlari suvda ham, quruqlikda ham bir xil samaradorlik bilan ishlashga qodir bo'lgan noyob uskunalar sinfidir. Gidravlik oyoqlari va gusenitsalari tufayli ular mustaqil ravishda quruqlikka chiqadi, botqoqliklardan o'tadi va juda sayoz suvlarda ishlaydi.",
      art3P2: "Murakkab logistika va joyida yig'ishni talab qiladigan klassik zemsnaryadlardan farqli o'laroq, amfibiya ob'ektga yetkazib berilgandan so'ng darhol ishlashga tayyor bo'ladi.",
      art3P3: "Amfibiyalarning qo'llanish sohalariga suv havzalarini o'simliklardan tozalash, daryo va ko'l tubini chuqurlashtirish, qirg'oqlarni mustahkamlash va suv toshqini oqibatlarini bartaraf etish kiradi.",
      art3P4: "O'zgaruvchan ishchi jihozlardan (paqir, tirirmish, frezer) foydalanish amfibiyani haqiqatan ham ko'p qirrali muhandislik mashinasiga aylantiradi.",
      art3P5: "DREDMARK zavodi MDHning ekstremal iqlim sharoitlariga moslashtirilgan ilg'or amfibiya yechimlarini taklif etadi.",
      art4Title: "Irrigatsiya kanallarini tiklash tajribasi: Qarshi loyihasi",
      art4Desc: "O'zbekistondagi Qarshi kaskadi irrigatsiya kanallarini chuqurlashtirish va tozalash amaliy keysi.",
      art4P1: "O'zbekistondagi Qarshi kaskadi irrigatsiya kanallari mintaqa qishloq xo'jaligida strategik rol o'ynaydi. Vaqt o'tishi bilan kanallar kuchli loyqalanishga duchor bo'ladi va o'tkazuvchanlik qobiliyatini yo'qotadi, bu esa dalalarni suv bilan ta'minlashni xavf ostiga qo'yadi.",
      art4P2: "Ushbu vazifani hal qilish uchun DREDMARK kompaniyasining og'ir daryo tozalash texnikasi jalb qilindi. Loyiha doirasida frezerli kuchli zemsnaryad ishlatildi.",
      art4P3: "Loyihaning asosiy qiyinchiligi kuchli oqim va nasos uskunalari hamda kesish qirralarining yuqori aşınmaya bardoshliligini talab qiladigan qattiq tub cho'kindilarining ko'pligi edi.",
      art4P4: "Amalga oshirilgan ishlar natijasida kaskadning o'tkazuvchanlik qobiliyati to'liq tiklandi va qishloq xo'jaligi dalalariga uzlusz suv yetkazib berish ta'minlandi.",
      art5Title: "Zemsnaryadga texnik xizmat ko'rsatish va mavsumga tayyorlash",
      art5Desc: "Zemsnaryadlarni ish mavsumiga tayyorlash, saqlash va texnik xizmat ko'rsatish bo'yicha amaliy qo'llanma.",
      art5P1: "Zemsnaryadga muntazam texnik xizmat ko'rsatish uning uzoq muddatli va uzluksiz ishlashining kafolatidir. Mavsumga tayyorgarlik suvga tushishdan ancha oldin boshlanadi va barcha tugunlarni diagnostika qilishni o'z ichiga oladi.",
      art5P2: "Grunt nasosiga alohida e'tibor berish lozim: zirhli disklar va ishchi g'ildirakning eskirganligini tekshiring. Eskirgan qismlarni o'z vaqtida almashtirish mavsum qizg'in pallada jiddiy nosozliklarning oldini oladi.",
      art5P3: "Gidravlik tizimni tekshiring: bosimni o'lchang, sizib chiqishlar yo'qligiga ishonch hosil qiling va kerak bo'lsa, moy hamda filtrlarni almashtiring. Toza moy frezer gidromotorlari va lebyodkalarining ishlash muddatini uzaytiradi.",
      art5P4: "DREDMARK zavodi original ehtiyot qismlarni qisqa muddatlarda yetkazib berish va joylarda diagnostika qilishni o'z ichiga olgan to'liq servis xizmatlarini ko'rsatadi.",
      art6Title: "Dnouguglashtirish (tubini chuqurlashtirish) ishlarida xavfsizlik texnikasi",
      art6Desc: "Zemsnaryad ekipaji va xizmat ko'rsatuvchi xodimlari uchun xavfsizlik texnikasining asosiy qoidalari va yo'riqnomalari.",
      art6P1: "Dnouguglashtirish ishlari yuqori xavfli ishlar toifasiga kiradi. Xavfsizlik texnikasi (XT) qoidalariga rioya qilish zemsnaryad ekipajining har bir a'zosi uchun majburiydir.",
      art6P2: "Smenani boshlashdan oldin paluba, to'siqlar, lebyodkalarni vizual ko'rikdan o'tkazish hamda favqulodda signalizatsiya va to'xtatish tugmalarining sozligini tekshirish lozim.",
      art6P3: "Barcha ekipaj a'zolari va bortdagi mutaxassislar qutqaruv nimchalari va himoya dubulg'alarini kiyishlari shart. Shaxsiy himoya vositalarisiz (SHHV) ishlash qat'iyan man etiladi.",
      art6P4: "Elektr kabellari holatiga (elektr zemsnaryadlar uchun) va pulpa quvurlarining mahkamligiga alohida e'tibor beriladi. Xodimlarga muntazam ravishda yo'riqnoma berish baxtsiz hodisalar xavfini kamaytiradi.",
