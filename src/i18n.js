...
const resources = {
  ru: {
    translation: {
      ...
      homeText4Card1: "Многофункциональный земснаряд амфибия с регистром судоходства от 4000м3 и выше",
      homeText4Card2: "Микро ГЭС",
      homeText4Card3: "Земснаряды без регистра судоходства",
      homeText4Card4: "Многофункциональные земснаряды с регистром судоходства",
      ...
      homeBannersCatalog: "📊 Скачать каталог и характеристики",

      homeModelTitle: "Модельный ряд земснарядов",
      homeTableTitle1: "Производительность",
      homeTableTitle2: "Глубина",
      homeTableTitlePrice: "Цена от",
      homeTablePrice1: "30 млн ₽",
      homeTablePrice2: "35 млн ₽",
      homeTablePrice3: "40 млн ₽",
      homeTablePrice4: "45 млн ₽",
      homeTablePrice5: "48 млн ₽",
      ...
      bannerSubtitle:
        "Собственное производство. Прямые цены без посредников. «Под ключ» — от расчёта до запуска за 4–6 месяцев.",
      bannerFactory: "Собственное производство: Ташкент, Узбекистан",
      ...
      fSitesTitle: "Наши сайты",
      caseClientLabel: "Заказчик",
      caseTaskLabel: "Задача",
      caseSolutionLabel: "Решение",
      caseResultLabel: "Результат",
      caseClient1: "Минводхоз Узбекистана",
      caseTask1: "Очистка и углубление ирригационных каналов Каршинского каскада",
      caseSolution1: "Поставлен 24-метровый земснаряд производительностью 4000 м³/ч с фрезерным рыхлителем",
      caseResult1: "Восстановлена пропускная способность каналов. Срок поставки — 5 месяцев",
      caseTag1: "🏆 Крупнейший проект",
      caseClient2: "Промышленный заказчик, Россия",
      caseTask2: "Добыча песка и ПГС с глубины 22 метра для строительного сектора",
      caseSolution2: "Спроектирован земснаряд 3500 м³/ч с усиленным грунтовым насосом для глубинной разработки",
      caseResult2: "Выход на проектную мощность 100 000 м³ в месяц",
      caseTag2: "⛏️ Глубинная добыча",
      caseClient3: "Экологическая служба",
      caseTask3: "Очистка водоёма от заиления и инвазивной растительности",
      caseSolution3: "Амфибийный земснаряд 1800 м³/ч — работает там, где обычная техника просто тонет",
      caseResult3: "Полная очистка водоёма за 3 месяца, восстановление экосистемы",
      caseTag3: "🌿 Амфибия",

      trustYr: "лет на рынке",
      trustDr: "земснарядов изготовлено",
      trustCtry: "стран СНГ доставка",
      trustReg: "Регистр судоходства",

      procTitle: "Как мы работаем",
      proc1T: "Заявка",
      proc1D: "Оставьте запрос на WhatsApp или форму",
      proc2T: "Расчёт",
      proc2D: "Инженер рассчитывает оптимальную конфигурацию",
      proc3T: "Предложение",
      proc3D: "Вы получаете КП с ценой, сроками и спецификацией",
      proc4T: "Производство и Доставка",
      proc4D: "Монтаж, обучение и запуск под ключ",
      procFooter: "Срок от заявки до поставки: 4-6 месяцев",

      fTrust1: "Отвечаем за 30 минут в рабочее время",
      fTrust2: "Бесплатный расчёт без обязательств",
      fTrust3: "Конфиденциальность данных гарантирована",
      fTrust4: "50+ земснарядов уже работают у клиентов",
      fProjectType: "Тип проекта (опционально)",
      fSand: "Добыча песка",
      fDredging: "Дноуглубление",
      fCleaning: "Очистка водоёмов",
      fOther: "Другое",
      fCapacity: "Требуемая производительность",
      ...
      specPerf: "Макс. производительность",
      specDepth: "Глубина дноуглубления",
      specDist: "Дальность выброса",
      specLead: "Срок изготовления",
      unitMonth: "мес.",

      artMainTitle: "Технологии",
      artBackToTech: "Вернуться в технологии",
      artNotFound: "Статья не найдена",
      artViewAll: "Все статьи",
      artReadMore: "Читать далее",
      art1Title: "Как выбрать земснаряд для добычи песка?",
      art1Desc: "Полный гид по параметрам: производительность, глубина, энергопотребление.",
      art2Title: "Расчет производительности земснаряда по пульпе",
      art2Desc: "Формулы и практические примеры для правильного подбора оборудования.",
      art1P1: "Выбор земснаряда — это критический шаг для любого гидротехнического проекта. От правильного подбора оборудования зависит не только скорость окупаемости, но и сама возможность выполнения работ.",
      art1P2: "Основные параметры, на которые стоит обратить внимание:",
      art1P3: "1. Производительность по пульпе. Измеряется в м³/ч. Важно понимать, что это объем смеси воды и грунта.",
      art1P4: "2. Глубина разработки. Стандартные модели DREDMARK работают на глубине до 14 метров.",
      art1P5: "3. Тип грунта. Для песка достаточно гидроразмыва, а для плотной глины или ила потребуется мощная фреза (рыхлитель).",
      art2P1: "Как правильно рассчитать, сколько грунта вы сможете добыть за смену?",
      art2P2: "Формулы и надежные методы расчета концентрации пульпы.",
      art2P3: "Также необходимо учитывать потери на трение в пульпопроводе и перепады высот.",
      artCtaTitle: "Нужна консультация по подбору оборудования?",
      ...
      usMainFreshH3: "Свежие проекты 2026 года",
      usMainFreshP8: "4000м3 электрический",
      usMainFreshP9: "Город Карши",
      gM3FreshH2026: "Галерея проектов в Карши 2026 года",
      ...
      whatsappMessage: "Здравствуйте! Я на странице:",
      whatsappTooltip: "Написать в WhatsApp",
      unitM: "м",
      unitH: "час",
      unitMonth: "мес",
      ...
      seoTitleHome: "Земснаряды от производителя | DREDMARK — купить земснаряд, цены, доставка",
      seoDescHome: "Земснаряды DREDMARK 2000–4500 м³/ч от производителя. Собственное производство в Узбекистане. Доставка в Россию, Казахстан, Таджикистан. Цены от 30 млн ₽. Запросите расчёт!",
      ...
      seoDescArticles: "Полезные статьи и технические руководства о земснарядах, дноуглублении и расчете производительности от завода DREDMARK.",
  ...
  en: {
    translation: {
      ...
      homeText4Card1: "Multifunctional amphibious dredger with shipping register from 4000m3 and above",
      homeText4Card2: "micro hydroelectric power station",
      homeText4Card3: "Dredgers without a shipping register",
      homeText4Card4: "Multifunctional dredgers with a shipping register",
      ...
      homeBannersCatalog: "📊 Download Catalog & Specs",

      homeModelTitle: "Model range of dredgers",
      homeTableTitle1: "Capacity",
      homeTableTitle2: "Depth",
      homeTableTitlePrice: "Price from",
      homeTablePrice1: "$320K",
      homeTablePrice2: "$380K",
      homeTablePrice3: "$430K",
      homeTablePrice4: "$480K",
      homeTablePrice5: "$520K",
      homeTableText1: "2000/63 Standard Dredger",
      ...
      bannerSubtitle:
        "Direct from manufacturer. No middlemen pricing. Turnkey delivery — from design to commissioning in 4–6 months.",
      bannerFactory: "Own manufacturing facility: Tashkent, Uzbekistan",
      ...
      fSitesTitle: "Our Websites",
      caseClientLabel: "Client",
      caseTaskLabel: "Challenge",
      caseSolutionLabel: "Solution",
      caseResultLabel: "Result",
      caseClient1: "Ministry of Water Resources, Uzbekistan",
      caseTask1: "Cleaning and deepening irrigation canals of the Karshi cascade",
      caseSolution1: "Delivered a 24-meter dredger with 4000 m³/h capacity and cutter head",
      caseResult1: "Canal throughput capacity restored. Delivery time — 5 months",
      caseTag1: "🏆 Largest project",
      caseClient2: "Industrial client, Russia",
      caseTask2: "Sand and gravel extraction from 22 meters depth for the construction sector",
      caseSolution2: "Engineered a 3500 m³/h dredger with heavy-duty soil pump for deep mining",
      caseResult2: "Reached design capacity of 100,000 m³ per month",
      caseTag2: "⛏️ Deep mining",
      caseClient3: "Environmental service",
      caseTask3: "Reservoir cleanup from silt and invasive vegetation",
      caseSolution3: "Amphibious dredger 1800 m³/h — operates where conventional equipment simply sinks",
      caseResult3: "Full reservoir cleanup in 3 months, ecosystem restoration",
      caseTag3: "🌿 Amphibia",

      trustYr: "years on the market",
      trustDr: "dredgers manufactured",
      trustCtry: "CIS countries delivery",
      trustReg: "Shipping Register",

      procTitle: "How We Work",
      proc1T: "Inquiry",
      proc1D: "Send a request via WhatsApp or form",
      proc2T: "Calculation",
      proc2D: "Engineer calculates the optimal configuration",
      proc3T: "Proposal",
      proc3D: "You receive a quote with price and specs",
      proc4T: "Production & Delivery",
      proc4D: "Installation, training, and turnkey launch",
      procFooter: "Lead time: 4-6 months",

      fTrust1: "We reply within 30 mins during work hours",
      fTrust2: "Free calculation with no obligations",
      fTrust3: "Data confidentiality guaranteed",
      fTrust4: "50+ dredgers operating worldwide",
      fProjectType: "Project type (optional)",
      fSand: "Sand extraction",
      fDredging: "Dredging",
      fCleaning: "Reservoir cleaning",
      fOther: "Other",
      fCapacity: "Required capacity",
      ...
      specPerf: "Max Performance",
      specDepth: "Dredging Depth",
      specDist: "Discharge Distance",
      specLead: "Production Lead Time",
      unitMonth: "mo.",

      artMainTitle: "Technologies",
      artBackToTech: "Back to Technologies",
      artNotFound: "Article not found",
      artViewAll: "View All",
      artReadMore: "Read More",
      art1Title: "How to choose a dredger for sand extraction?",
      art1Desc: "Complete guide on parameters: performance, depth, power consumption.",
      art2Title: "Calculating dredger pulp performance",
      art2Desc: "Formulas and practical examples for correct equipment selection.",
      art1P1: "Choosing a dredger is a critical step for any hydraulic project. The correct selection affects not only the payback period but also the very feasibility of the work.",
      art1P2: "Key parameters to focus on:",
      art1P3: "1. Pulp performance (m³/h). It's important to understand this is the total volume of water and soil mixture.",
      art1P4: "2. Development depth. Standard DREDMARK models operate at depths up to 14 meters.",
      art1P5: "3. Soil type. Water jetting is sufficient for sand, but a powerful cutter is needed for dense clay or silt.",
      art2P1: "How to correctly calculate the amount of soil you can extract in a shift?",
      art2P2: "Formula: Pulp flow × concentration (usually 10-20%) = real production.",
      art2P3: "Friction losses in the pipeline and elevation changes must also be considered.",
      artCtaTitle: "Need a consultation on equipment selection?",
      ...
      whatsappMessage: "Hello! I'm on the page:",
      ...
      seoTitleHome: "Industrial Dredgers for Sale | DREDMARK — Manufacturer Direct Prices",
      seoDescHome: "DREDMARK industrial dredgers 2000–4500 m³/h — direct from manufacturer. Own production in Uzbekistan. Delivery to CIS & worldwide. Prices from $300K. Request a quote!",
      ...
      seoDescArticles: "Useful articles and technical guides on dredgers, dredging, and performance calculation from the DREDMARK manufacturing plant.",
      ...
      usMainFreshH3: "Fresh Projects 2026",
      usMainFreshP8: "4000m3 Electric",
      usMainFreshP9: "Karshi city",
      gM3FreshH2026: "Gallery of projects in Karshi 2026",
    },
  },
  ...
  uz: {
    translation: {
      ...
      homeText4Card1: "Kema registri bilan 4000 m3 va undan yuqori ko'p funksiyali amfibiya zemsnaryadi",
      homeText4Card2: "mikro gidroelektr stansiyasi",
      homeText4Card3: "Yuk tashish reestriga ega bo'lmagan dredgerlar",
      homeText4Card4: "Ko'p funksiyali yuk tashish reestriga ega bo'lgan dredgerlar",
      ...
      homeBannersCatalog: "📊 Katalog va texnik tavsiflarni yuklash",

      homeModelTitle: "Zemsnaryadlar model qatori",
      homeTableTitle1: "Unumdorlik",
      homeTableTitle2: "Chuqurlik",
      homeTableTitlePrice: "Narxi ...dan",
      homeTablePrice1: "30 mln ₽",
      homeTablePrice2: "35 mln ₽",
      homeTablePrice3: "40 mln ₽",
      homeTablePrice4: "45 mln ₽",
      homeTablePrice5: "48 mln ₽",
      homeTableText1: "Zemsnaryad 2000/63 standart",
      ...
      homeTableBtn: "Narx va muddatni bilish",
      ...
      bannerTitle:
        "Qum qazib olish va chuqurlashtirish uchun 2000–4500 m³/soat zemsnaryadlar",
      bannerSubtitle:
        "O'z ishlab chiqarishimiz. Vositasiz to'g'ridan-to'g'ri narxlar. 4-6 oy ichida kalit taslim.",
      bannerFactory: "O'z ishlab chiqarish: Toshkent, O'zbekiston",
      ...
      fP9: "Texnik direktor:",
      fSitesTitle: "Bizning saytlarimiz",
      caseClientLabel: "Buyurtmachi",
      caseTaskLabel: "Vazifa",
      caseSolutionLabel: "Yechim",
      caseResultLabel: "Natija",
      caseClient1: "O'zbekiston Suv xo'jaligi vazirligi",
      caseTask1: "Qashqadaryo kaskadi irrigatsiya kanallarini tozalash va chuqurlashtirish",
      caseSolution1: "4000 m³/soat unumdorlikka ega 24 metrli zemsnaryad frezerli yumshatgich bilan yetkazildi",
      caseResult1: "Kanallarning o'tkazuvchanlik qobiliyati tiklandi. Yetkazib berish muddati — 5 oy",
      caseTag1: "🏆 Eng yirik loyiha",
      caseClient2: "Sanoat buyurtmachisi, Rossiya",
      caseTask2: "Qurilish sektori uchun 22 metr chuqurlikdan qum va shag'al qazib olish",
      caseSolution2: "Chuqur qazish uchun kuchaytirilgan gruntli nasos bilan 3500 m³/soat zemsnaryad loyihalandi",
      caseResult2: "Oyiga 100 000 m³ loyiha quvvatiga chiqildi",
      caseTag2: "⛏️ Chuqur qazib olish",
      caseClient3: "Ekologiya xizmati",
      caseTask3: "Suv havzasini loyqa va invaziv o'simliklardan tozalash",
      caseSolution3: "Amfibiya zemsnaryad 1800 m³/soat — oddiy texnika cho'kib ketadigan joyda ishlaydi",
      caseResult3: "3 oyda suv havzasi to'liq tozalandi, ekotizim tiklandi",
      caseTag3: "🌿 Amfibiya",

      trustYr: "bozorda faoliyat",
      trustDr: "zemsnaryad ishlab chiqarilgan",
      trustCtry: "MDH davlatlariga yetkazib berish",
      trustReg: "Kema registri",

      procTitle: "Biz qanday ishlaymiz",
      proc1T: "So'rov",
      proc1D: "WhatsApp yoki shakl orqali so'rov qoldiring",
      proc2T: "Hisob-kitob",
      proc2D: "Muhandis optimal konfiguratsiyani hisoblaydi",
      proc3T: "Taklif",
      proc3D: "Narx va muddatlar bilan tijorat taklifi olasiz",
      proc4T: "Ishlab chiqarish va Etkazib berish",
      proc4D: "O'rnatish, o'qitish va kalit taslim topshirish",
      procFooter: "Buyurtmadan yetkazib berishgacha: 4-6 oy",

      fTrust1: "Ish vaqtida 30 daqiqada javob beramiz",
      fTrust2: "Majburiyatlarsiz bepul hisob-kitob",
      fTrust3: "Ma'lumotlar maxfiyligi kafolatlanadi",
      fTrust4: "50+ zemsnaryad mijozlarda ishlamoqda",
      fProjectType: "Loyiha turi (ixtiyoriy)",
      fSand: "Qum qazib olish",
      fDredging: "Tubini chuqurlashtirish",
      fCleaning: "Suv havzalarini tozalash",
      fOther: "Boshqa",
      fCapacity: "Kerakli unumdorlik",
      ...
      specPerf: "Maksimal unumdorlik",
      specDepth: "Qazish chuqurligi",
      specDist: "Uzatish masofasi",
      specLead: "Ishlab chiqarish muddati",
      unitMonth: "oy",

      artMainTitle: "Texnologiyalar",
      artBackToTech: "Texnologiyalarga qaytish",
      artNotFound: "Maqola topilmadi",
      artViewAll: "Barcha maqolalar",
      artReadMore: "Batafsil o'qish",
      art1Title: "Qum qazib olish uchun zemsnaryadni qanday tanlash mumkin?",
      art1Desc: "Parametrlar bo'yicha to'liq qo'llanma: unumdorlik, chuqurlik, quvvat sarfi.",
      art2Title: "Pulpa bo'yicha zemsnaryad unumdorligini hisoblash",
      art2Desc: "Uskunani to'g'ri tanlash uchun formulalar va amaliy misollar.",
      art1P1: "Zemsnaryadni tanlash har qanday gidrotexnika loyihasi uchun muhim qadamdir. Uskunaning to'g'ri tanlanishi nafaqat investitsiyaning qaytish tezligiga, balki ishning bajarilish imkoniyatiga ham bog'liq.",
      art1P2: "E'tibor berish kerak bo'lgan asosiy parametrlar:",
      art1P3: "1. Pulpa bo'yicha unumdorlik (m³/soat). Bu suv va tuproq aralashmasining umumiy hajmi ekanligini tushunish muhimdir.",
      art1P4: "2. Qazish chuqurligi. Standart DREDMARK modellari 14 metrgacha chuqurlikda ishlaydi.",
      art1P5: "3. Tuproq turi. Qum uchun gidro-yuvish yetarli, ammo qattiq gil yoki loy uchun kuchli freza kerak bo'ladi.",
      art2P1: "Bir smenada qancha tuproq qazib olishingizni qanday to'g'ri hisoblash mumkin?",
      art2P2: "Formula: Pulpa oqimi × konsentratsiya (odatda 10-20%) = haqiqiy ishlab chiqarish.",
      art2P3: "Quvurlardagi ishqalanish va harakatlanish masofasini ham hisobga olish kerak.",
      artCtaTitle: "Uskunani tanlash bo'yicha maslahat kerakmi?",
      ...
      vozmMainSection8P24: "45 million ₽ dan",
      ...
      usMainFreshH3: "2026-yilgi yangi loyihalar",
      usMainFreshP8: "4000m3 elektr",
      usMainFreshP9: "Qarshi shahri",
      gM3FreshH2026: "Qarshidagi 2026-yilgi yangi loyihalar galereyasi",
      ...
      whatsappMessage: "Salom! Men sahifadaman:",
      whatsappTooltip: "WhatsApp orqali yozish",
      unitM: "m",
      unitH: "soat",
      unitMonth: "oy",
      ...
      seoTitleHome: "Ishlab chiqaruvchidan zemsnaryadlar | DREDMARK — narxlar, yetkazib berish",
      seoDescHome: "DREDMARK zemsnaryadlari 2000–4500 m³/soat. O'zbekistonda ishlab chiqarish. O'zbekiston bo'ylab va MDHga yetkazib berish. 30 million rubldan narxlar. Hisob-kitobni so'rang!",
      ...
      seoDescArticles: "DREDMARK zavodidan zemsnaryadlar, daryo tubini tozalash va unumdorlikni hisoblash bo'yicha foydali maqolalar va texnik qo'llanmalar.",
