...
const resources = {
  ru: {
    translation: {
      ...
      homeText4Card1: "Многофункциональный земснаряд амфибия с регистром судоходства от 600м3 и выше",
  ...
  en: {
    translation: {
      ...
      homeText4Card1: "Multifunctional amphibious dredger with shipping register from 600m3 and above",
  ...
  uz: {
    translation: {
      ...
      homeText4Card1: "Kema registri bilan 600 m3 va undan yuqori ko'p funksiyali amfibiya zemsnaryadi",
